...
const Settings = ({ onClose }) => {
    //gestion d'ouverture et de fermeture de la page de suppression
    ...
    const handleCloseThirdPopup = () => {
        setThirdPopupOpen(false)
    }

    //gestion d'ouverture et de fermeture de la page de modification
    const [isFifthPopupOpen, setFifthPopupOpen] = useState(false)
    const handleOpenFifthPopup = () => {
        setFifthPopupOpen(true)
    }
    const handleCloseFifthPopup = () => {
        ...
        <div>
            <Box className="settings">
                ...
                <div className="settings__user">
                    <div className="settings__Jenee">
                        <JeneeAvatar fontSize={12} />
                    </div>
                    <div>
                        {' '}
                ...
                <div className="settings__buttons">
                    <div>
                        <button className="settings__button2-modi" onClick={handleOpenFifthPopup}>
                            Modifier mon mot de passe
                        </button>
                        {isFifthPopupOpen && <EditPassword onClose={handleCloseFifthPopup} />}
                    </div>
                    <div>
                        <button className="settings__button1-delet" onClick={handleOpenThirdPopup}>
                            Supprimer mon compte
                        </button>
                        {isThirdPopupOpen && <Suppression onClose={handleCloseThirdPopup} />}
                    </div>
                </div>
            </Box>
        </div>
