...
*/
const SignUpComponentStepThree = ({
    setFormValue,
    formValue,
    HandleSubmit,
    handleChange,
    ...
    return (
        <Box component={'div'} className="card card--no-margin">
            ...
            <Link className="card__footer-title--tutorial" to={ROUTES.AUTHENTIFICATION.SIGN_UP.NAME}>
...
SignUpComponentStepThree.propTypes = {
...
export default SignUpComponentStepThree
